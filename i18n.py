...
UI = {
 "nl": {
    ...
    "stars_label": "4.9 · 136 reviews — lees de beoordelingen",
 ...
 "en": {
    ...
    "stars_label": "4.9 · 136 reviews — read the reviews",
    "stars_txt": "4.9 · 136 reviews",
 ...
 "de": {
    ...
    "stars_label": "4.9 · 136 Bewertungen — Bewertungen lesen",
 ...
 "fr": {
    ...
    "stars_label": "4.9 · 136 avis — lire les avis",
...
FORM = {
 "en": {
    ...
    "msg_ok_nc": "\U0001F525 Done — your request has been sent! I'll reply personally <b>within 24 hours</b>.",
 ...
 "de": {
    ...
    "msg_ok_nc": "\U0001F525 Geschafft — Ihre Anfrage ist unterwegs! Ich antworte persönlich <b>innerhalb von 24 Stunden</b>.",
 ...
 "fr": {
    ...
    "msg_ok_nc": "\U0001F525 C'est fait — votre demande est envoyée ! Je réponds personnellement <b>sous 24 heures</b>.",
...
PAGES["en"]["fotos"] = {
 ...
 "captions": {
    ...
    "galavuur":      ("Column of fire at a gala party", "In a white gala suit, Nuno blows a towering column of fire between flowers and candles at an elegant party"),
    "zonsondergang": ("Fireball over the water at sunset", "Fire breather Nuno in a glitter jacket blowing a fireball over the water at sunset for an audience"),
    "nachtvuur":     ("Fireball above the night-time street", "Fire breather Nuno with two torches blowing a large fireball straight up into the night"),
    "terrasvuur":    ("Fire show on the terrace in the rain", "Kneeling, fire breather Nuno blows a long flame across the terrace, even in the rain"),
    "portret":       ("Portrait in the stage light", "Portrait of fire breather and mentalist Nuno with hat in purple-red stage light"),
    "vuurhart":        ("Heart-shaped fireball", "Fire breather Nuno blowing a heart-shaped fireball against the summer sky"),
    "cirque":          ("Circus night: audience on the bed of nails", "Spectator standing on the bed of nails on Nuno during a spectacular circus night with confetti"),
    "spijkersandwich": ("The nail sandwich in the nightclub", "Fakir act in the club: Nuno lying between two beds of nails while a spectator stands on top"),
    "themafakir":      ("Fakir act at a theme party", "Guest standing on the nail board on Nuno during an Asian theme party, helped by two ladies in kimono"),
    "familiefest":     ("Fireball at the family festival", "Fire breather Nuno in a red circus jacket blowing a fireball above the crowd at a summer family festival"),
...
PAGES["de"]["fotos"] = {
 ...
 "captions": {
    ...
    "galavuur":      ("Feuersäule auf einem Galafest", "Im weißen Gala-Anzug bläst Nuno eine meterhohe Feuersäule zwischen Blumen und Kerzen auf einem edlen Fest"),
    "zonsondergang": ("Feuerball über dem Wasser bei Sonnenuntergang", "Feuerspucker Nuno in Glitzerjacke bläst bei Sonnenuntergang einen Feuerball über das Wasser"),
    "nachtvuur":     ("Feuerball über der nächtlichen Straße", "Feuerspucker Nuno bläst mit zwei Fackeln einen großen Feuerball senkrecht in die Nacht"),
    "terrasvuur":    ("Feuershow auf der Terrasse im Regen", "Kniend bläst Feuerspucker Nuno eine lange Flamme über die Terrasse, sogar im Regen"),
    "portret":       ("Porträt im Bühnenlicht", "Porträt von Feuerspucker und Mentalist Nuno mit Hut im violett-roten Bühnenlicht"),
    "vuurhart":        ("Herzförmiger Feuerball", "Feuerspucker Nuno bläst einen herzförmigen Feuerball in den Sommerhimmel"),
    "cirque":          ("Zirkusnacht: Publikum auf dem Nagelbrett", "Zuschauerin steht auf dem Nagelbrett auf Nuno während einer spektakulären Zirkusnacht mit Konfetti"),
    "spijkersandwich": ("Das Nagel-Sandwich im Nachtclub", "Fakir-Act im Club: Nuno liegt zwischen zwei Nagelbrettern, während ein Zuschauer darauf steht"),
    "themafakir":      ("Fakir-Act auf einer Mottoparty", "Gast steht auf dem Nagelbrett auf Nuno bei einer asiatischen Mottoparty, gestützt von zwei Damen im Kimono"),
    "familiefest":     ("Feuerball auf dem Familienfestival", "Feuerspucker Nuno in roter Zirkusjacke bläst einen Feuerball über dem Publikum eines Familienfestivals"),
...
PAGES["fr"]["fotos"] = {
 ...
 "captions": {
    ...
    "galavuur":      ("Colonne de feu lors d'un gala", "En costume de gala blanc, Nuno souffle une colonne de feu immense entre fleurs et bougies lors d'une fête chic"),
    "zonsondergang": ("Boule de feu sur l'eau au coucher du soleil", "Le cracheur de feu Nuno en veste pailletée souffle une boule de feu au-dessus de l'eau au coucher du soleil"),
    "nachtvuur":     ("Boule de feu au-dessus de la rue nocturne", "Le cracheur de feu Nuno, deux torches en main, souffle une grande boule de feu droit dans la nuit"),
    "terrasvuur":    ("Spectacle de feu en terrasse sous la pluie", "À genoux, le cracheur de feu Nuno souffle une longue flamme sur la terrasse, même sous la pluie"),
    "portret":       ("Portrait dans la lumière de scène", "Portrait du cracheur de feu et mentaliste Nuno, chapeau vissé, dans une lumière de scène pourpre"),
    "vuurhart":        ("Boule de feu en forme de cœur", "Le cracheur de feu Nuno souffle une boule de feu en forme de cœur dans le ciel d'été"),
    "cirque":          ("Soirée cirque : le public sur la planche à clous", "Spectatrice debout sur la planche à clous posée sur Nuno lors d'une soirée cirque spectaculaire"),
    "spijkersandwich": ("Le sandwich à clous en boîte de nuit", "Numéro de fakir en club : Nuno allongé entre deux planches à clous, un spectateur debout dessus"),
    "themafakir":      ("Numéro de fakir en soirée à thème", "Une invitée debout sur la planche à clous posée sur Nuno lors d'une soirée à thème asiatique"),
    "familiefest":     ("Boule de feu au festival familial", "Le cracheur de feu Nuno en veste de cirque rouge souffle une boule de feu au-dessus du public d'un festival familial"),
