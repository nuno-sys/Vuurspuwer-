...
# ============================================================== ENGELS
 "en": {
  ...
  '>NIEUW<':
  '>NEW<',
  'alt="In wit gala-kostuum blaast Nuno een metershoge vuurzuil tussen bloemen en kaarsen op een chique feest"': 'alt="In a white gala suit, Nuno blows a towering column of fire between flowers and candles at an elegant party"',
  'alt="Vuurspuwer Nuno in glitterjasje blaast een vuurbal over het water bij zonsondergang voor publiek"': 'alt="Fire breather Nuno in a glitter jacket blowing a fireball over the water at sunset for an audience"',
  'alt="Vuurspuwer Nuno blaast met twee fakkels een grote vuurbal recht omhoog in de nacht"': 'alt="Fire breather Nuno with two torches blowing a large fireball straight up into the night"',
  'alt="Geknield blaast vuurspuwer Nuno een lange vlam over het terras, zelfs in de regen"': 'alt="Kneeling, fire breather Nuno blows a long flame across the terrace, even in the rain"',
  'alt="Portret van vuurspuwer en mentalist Nuno met hoed in paars-rood stagelicht"': 'alt="Portrait of fire breather and mentalist Nuno with hat in purple-red stage light"',
  'alt="Vuurspuwer Nuno blaast een vuurbal in de vorm van een hart tegen de zomerlucht"': 'alt="Fire breather Nuno blowing a heart-shaped fireball against the summer sky"',
  'alt="Toeschouwer staat op het spijkerbed op Nuno tijdens een spectaculaire circusavond met confetti"': 'alt="Spectator standing on the bed of nails on Nuno during a spectacular circus night with confetti"',
  'alt="Fakiract in de club: Nuno ligt tussen twee spijkerbedden terwijl een toeschouwer er bovenop staat"': 'alt="Fakir act in the club: Nuno lying between two beds of nails while a spectator stands on top"',
  'alt="Gast staat op het spijkerbord op Nuno tijdens een Aziatisch themafeest, geholpen door twee dames in kimono"': 'alt="Guest standing on the nail board on Nuno during an Asian theme party, helped by two ladies in kimono"',
  'alt="Vuurspuwer Nuno in rood circusjasje blaast een vuurbal boven het publiek op een zomers familiefestival"': 'alt="Fire breather Nuno in a red circus jacket blowing a fireball above the crowd at a summer family festival"',
...
# ============================================================== DUITS
 "de": {
  ...
  '>NIEUW<':
  '>NEU<',
  'alt="In wit gala-kostuum blaast Nuno een metershoge vuurzuil tussen bloemen en kaarsen op een chique feest"': 'alt="Im weißen Gala-Anzug bläst Nuno eine meterhohe Feuersäule zwischen Blumen und Kerzen auf einem edlen Fest"',
  'alt="Vuurspuwer Nuno in glitterjasje blaast een vuurbal over het water bij zonsondergang voor publiek"': 'alt="Feuerspucker Nuno in Glitzerjacke bläst bei Sonnenuntergang einen Feuerball über das Wasser"',
  'alt="Vuurspuwer Nuno blaast met twee fakkels een grote vuurbal recht omhoog in de nacht"': 'alt="Feuerspucker Nuno bläst mit zwei Fackeln einen großen Feuerball senkrecht in die Nacht"',
  'alt="Geknield blaast vuurspuwer Nuno een lange vlam over het terras, zelfs in de regen"': 'alt="Kniend bläst Feuerspucker Nuno eine lange Flamme über die Terrasse, sogar im Regen"',
  'alt="Portret van vuurspuwer en mentalist Nuno met hoed in paars-rood stagelicht"': 'alt="Porträt von Feuerspucker und Mentalist Nuno mit Hut im violett-roten Bühnenlicht"',
  'alt="Vuurspuwer Nuno blaast een vuurbal in de vorm van een hart tegen de zomerlucht"': 'alt="Feuerspucker Nuno bläst einen herzförmigen Feuerball in den Sommerhimmel"',
  'alt="Toeschouwer staat op het spijkerbed op Nuno tijdens een spectaculaire circusavond met confetti"': 'alt="Zuschauerin steht auf dem Nagelbrett auf Nuno während einer spektakulären Zirkusnacht mit Konfetti"',
  'alt="Fakiract in de club: Nuno ligt tussen twee spijkerbedden terwijl een toeschouwer er bovenop staat"': 'alt="Fakir-Act im Club: Nuno liegt zwischen zwei Nagelbrettern, während ein Zuschauer darauf steht"',
  'alt="Gast staat op het spijkerbord op Nuno tijdens een Aziatisch themafeest, geholpen door twee dames in kimono"': 'alt="Gast steht auf dem Nagelbrett auf Nuno bei einer asiatischen Mottoparty, gestützt von zwei Damen im Kimono"',
  'alt="Vuurspuwer Nuno in rood circusjasje blaast een vuurbal boven het publiek op een zomers familiefestival"': 'alt="Feuerspucker Nuno in roter Zirkusjacke bläst einen Feuerball über dem Publikum eines Familienfestivals"',
...
# ============================================================== FRANS
 "fr": {
  ...
  '>NIEUW<':
  '>NOUVEAU<',
  'alt="In wit gala-kostuum blaast Nuno een metershoge vuurzuil tussen bloemen en kaarsen op een chique feest"': 'alt="En costume de gala blanc, Nuno souffle une colonne de feu immense entre fleurs et bougies lors d&rsquo;une fête chic"',
  'alt="Vuurspuwer Nuno in glitterjasje blaast een vuurbal over het water bij zonsondergang voor publiek"': 'alt="Le cracheur de feu Nuno en veste pailletée souffle une boule de feu au-dessus de l&rsquo;eau au coucher du soleil"',
  'alt="Vuurspuwer Nuno blaast met twee fakkels een grote vuurbal recht omhoog in de nacht"': 'alt="Le cracheur de feu Nuno, deux torches en main, souffle une grande boule de feu droit dans la nuit"',
  'alt="Geknield blaast vuurspuwer Nuno een lange vlam over het terras, zelfs in de regen"': 'alt="À genoux, le cracheur de feu Nuno souffle une longue flamme sur la terrasse, même sous la pluie"',
  'alt="Portret van vuurspuwer en mentalist Nuno met hoed in paars-rood stagelicht"': 'alt="Portrait du cracheur de feu et mentaliste Nuno, chapeau vissé, dans une lumière de scène pourpre"',
  'alt="Vuurspuwer Nuno blaast een vuurbal in de vorm van een hart tegen de zomerlucht"': 'alt="Le cracheur de feu Nuno souffle une boule de feu en forme de cœur dans le ciel d&rsquo;été"',
  'alt="Toeschouwer staat op het spijkerbed op Nuno tijdens een spectaculaire circusavond met confetti"': 'alt="Spectatrice debout sur la planche à clous posée sur Nuno lors d&rsquo;une soirée cirque spectaculaire"',
  'alt="Fakiract in de club: Nuno ligt tussen twee spijkerbedden terwijl een toeschouwer er bovenop staat"': 'alt="Numéro de fakir en club : Nuno allongé entre deux planches à clous, un spectateur debout dessus"',
  'alt="Gast staat op het spijkerbord op Nuno tijdens een Aziatisch themafeest, geholpen door twee dames in kimono"': 'alt="Une invitée debout sur la planche à clous posée sur Nuno lors d&rsquo;une soirée à thème asiatique"',
  'alt="Vuurspuwer Nuno in rood circusjasje blaast een vuurbal boven het publiek op een zomers familiefestival"': 'alt="Le cracheur de feu Nuno en veste de cirque rouge souffle une boule de feu au-dessus du public d&rsquo;un festival familial"',
